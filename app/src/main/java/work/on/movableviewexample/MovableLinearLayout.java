        ...
        if (action == MotionEvent.ACTION_DOWN) {
            ...
            if(borderX>borderY) {
                if(view.getY()>viewParent2.getHeight()/2) { //view near Bottom
                    ...
                    finalY = Math.max(0, finalY) + fab_margin+50; // Don't allow the FAB past the top of the parent
                }
                ...
                if(view.getX()>viewParent2.getWidth()/2) {
                    ...
                    finalX = Math.max(0, finalX) - fab_margin+40; // Don't allow the FAB past the left hand side of the parent
                }
                else {  //view near Left
                    finalX = viewParent2.getLeft();
                    finalX = Math.min(viewParent2.getWidth() - view.getWidth(), finalX) + fab_margin-40; // Don't allow the FAB past the right hand side of the parent
                }
            ...
            Log.e("borderxy","x "+finalX+", y "+borderY);
            Log.e("borderxy","Fx "+borderX+", Fy "+finalY);
